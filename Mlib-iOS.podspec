#
# Be sure to run `pod spec lint Mlib-iOS.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  #
  # s.author       = 'mmertsock', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  #s.source       = { :git => "http://EXAMPLE/Mlib-iOS.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/Mlib-iOS/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/Mlib-iOS', :revision => '1.0.0' }
